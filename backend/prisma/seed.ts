...
async function main() {
  ...
  const defaults: Record<string, UserRole[]> = {
    INVENTORY_CAPTURE: [UserRole.ADMIN, UserRole.SUPERVISOR, UserRole.WAREHOUSE, UserRole.EQUIPMENT], INVENTORY_APPROVE: [UserRole.ADMIN, UserRole.APPROVER], INVENTORY_CANCEL: [UserRole.ADMIN, UserRole.APPROVER], REPORT_CAPTURE: [UserRole.ADMIN, UserRole.APPROVER, UserRole.SUPERVISOR, UserRole.WAREHOUSE, UserRole.EQUIPMENT], REPORT_PUBLISH: [UserRole.ADMIN, UserRole.APPROVER, UserRole.SUPERVISOR], REPORT_APPROVE: [UserRole.ADMIN, UserRole.APPROVER], EQUIPMENT_CAPTURE: [UserRole.ADMIN, UserRole.EQUIPMENT, UserRole.SUPERVISOR],
  };
