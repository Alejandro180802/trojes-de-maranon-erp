...
Fuente funcional: `ENCUESTA.docx`. Esta matriz describe la implementación local; la
conexión y validación en Supabase, Firebase y Google Cloud se ejecutarán después.

| Necesidad de la encuesta | Implementación |
|---|---|
...
| Roles y autorizaciones | Seis roles y matriz de permisos configurable, aplicada por el API |
